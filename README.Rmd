...
<!-- badges: start -->
[![R build status](https://github.com/maximilian-muecke/firmValueSim/workflows/R-CMD-check/badge.svg)](https://github.com/maximilian-muecke/firmValueSim/actions?workflow=R-CMD-check)
...
Warning: Current version is still under heavy development and may contain bugs.
