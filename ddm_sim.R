ddm_norm <- function(price, dividend, g_mu, g_sigma, n_sim = 1000) {
...
ddm_tri <- function(price, dividend, g_min, g_max, n_sim = 1000) {
...
ddm_unif <- function(price, dividend, g_min, g_max, n_sim = 1000) {
